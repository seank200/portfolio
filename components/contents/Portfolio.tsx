...
const portfolioDict = createIntlDict(
  ...
  },
  {
    PORTFOLIO: '포트폴리오',
    SUBHEADING:
      '제가 참여했던 프로젝트들을 소개합니다. 개인적으로 진행한 토이 프로젝트부터 오픈 소스 프로젝트 기여까지 경험하며, 주어진 일을 스스로 끝마치는 책임감부터 여러 사람과 함께 의견을 공유하고 협업하는 법을 배웠습니다. 아래 프로젝트들 모두는 전부 또는 일부를 제가 직접 기획하고 구현한 결과물이며, 단순히 강의 영상을 따라만 한 결과물과 클론 코딩은 포함하지 않았습니다.',
