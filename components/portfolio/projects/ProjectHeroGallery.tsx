...
export default function ProjectHeroGallery({
  ...
  return (
    <div className="-z-10 absolute top-0 right-0 left-0 h-screen overflow-hidden">
      <div className="absolute top-0 right-0 left-0 bottom-0 bg-gradient-to-b from-background/40 to-background dark:from-background/70 dark:to-background"></div>
      <div
        ref={gridRef}
        className="-z-10 absolute -top-40 -right-20 -bottom-40 -left-40 group-hover/project:scale-102 transition-transform grid grid-cols-5 gap-4 rotate-12"
      >
        {Array(5)
          .fill(0)
          .map((v, col) => (
