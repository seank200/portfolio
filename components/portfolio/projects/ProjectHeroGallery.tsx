...
export default function ProjectHeroGallery({
  ...
  return (
    <div className="-z-10 absolute top-0 right-0 left-0 h-screen overflow-hidden">
      <div className="z-10 absolute top-0 right-0 left-0 bottom-0 bg-gradient-to-b from-background/50 to-background dark:from-background/70 dark:to-background"></div>
      <div
        ref={gridRef}
