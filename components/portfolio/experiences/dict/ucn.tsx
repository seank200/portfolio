...
export const ucnDict = createIntlDict(
  {
    ...
    details: [
      <>
        ...
        deterministic tractography. <ExpTag>#c++</ExpTag>
        <ExpTag>#matlab</ExpTag>
        <ExpTag>#python</ExpTag>
      </>,
      <>
        ...
        nodes. <ExpTag>#linux</ExpTag>
        <ExpTag>#bash_scripting</ExpTag>
      </>,
      // <>
      ...
      <>
        ...
        to merge the PRs to the upstream repo. <ExpTag>#git</ExpTag>
        <ExpTag>#github</ExpTag>
        <ExpTag>#gitlab</ExpTag>
      </>,
      <>
  ...
  },
  {
    ...
    details: [
      <>
        ...
        신경섬유추적지도 생성 알고리즘 개발에 기여함. <ExpTag>#c++</ExpTag>
        <ExpTag>#matlab</ExpTag>
        <ExpTag>#python</ExpTag>
      </>,
      <>
      ...
      <>
        ...
        머지시키는 등의 업무를 담당함. <ExpTag>#git</ExpTag>
        <ExpTag>#github</ExpTag>
        <ExpTag>#gitlab</ExpTag>
      </>,
      <>
