...
export const ceosDict = createIntlDict(
  ...
  },
  {
    role: "프론트엔드 멘토",
    category: "동아리 활동",
    division: "웹 프론트엔드 파트 13기",
    affiliation: "신촌대학연합 IT창업동아리 CEOS",
    details: [
      "[멘토] 6개월 활동 후 멘토로 선발되어, 웹 개발 경험이 없거나 적은 신규 부원 10-15명을 대상으로 진행된 스터디에 매주 참석하여 HTML, CSS, JS 등의 웹 개발 기초와 React 프레임워크 교육을 진행함. 스터디 진행 후 신규 부원들은 약 2개월 만에 직접 기획한 서비스의 프론트엔드 개발을 맡아 런칭할 수 있을 정도로 개발 실력이 향상되었음.",
      "[부원] 매주 파트 정규 스터디 세션을 통해 React 개발 실습 과제를 수행하고, 이론 스터디를 진행함, 매주 동아리 정규 세션에 참여하여 서비스 기획, 시장 조사, 마케팅 계획 등 서비스 런칭에 필요한 지식을 습득하였음. 정규 세션과는 별도로, 동기 부원들과 함께 전 활동기간에 걸쳐 일일 스터디를 함께 진행하여 개발 과제 진행과 이론 공부를 진행하였음.",
    ],
  },
);
