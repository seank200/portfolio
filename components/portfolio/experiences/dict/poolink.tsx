...
export const poolinkDict = createIntlDict(
  {
    ...
    details: [
      <>
        ...
        using ReactJS. <ExpTag>#JavaScript</ExpTag>
        <ExpTag>#React</ExpTag>
        <ExpTag>#responsive-design</ExpTag>
      </>,
      <>
        ...
        production deployment <ExpTag>#vercel</ExpTag>
        <ExpTag>#git</ExpTag>
        <ExpTag>#github-actions</ExpTag>
      </>,
      <>
  ...
  },
  {
    ...
    details: [
      <>
        ...
        최적화함. <ExpTag>#javascript</ExpTag>
        <ExpTag>#react</ExpTag>
        <ExpTag>#redux</ExpTag>
        <ExpTag>#react-query</ExpTag>
        <ExpTag>#responsive-design</ExpTag>
      </>,
      <>
        <span className="font-bold">[DevOps] </span>
