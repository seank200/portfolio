...
export const yicrcDict = createIntlDict(
  {
    role: "Vice Chief Residential Assistant",
    ...
    details: [
      <>
        ...
        feedbacks. <ExpTag>#html</ExpTag>
        <ExpTag>#css</ExpTag>
        <ExpTag>#vanilla-js</ExpTag>
        <ExpTag>#jquery</ExpTag>
        <ExpTag>#php</ExpTag>
        <ExpTag>#mysql</ExpTag>
      </>,
  ...
  {
    role: "부선임조교 (RA, Residential Assistant)",
    category: "교내 근무경험",
    division: "학부대학 RC교육원",
    affiliation: "연세대학교",
    details: [
