...
export const facadeDict = createIntlDict(
  {
    ...
    details: [
      ...
      <>
        ...
        hosting. <ExpTag>#nodejs</ExpTag>
        <ExpTag>#typescript</ExpTag>
      ...
      <>
        ...
        <ExpTag>#aws</ExpTag>
        <ExpTag>#aws-ec2</ExpTag>
        <ExpTag>#aws-rds</ExpTag>
        <ExpTag>#aws-dynamo-db</ExpTag>
        <ExpTag>#aws-s3</ExpTag>
        <ExpTag>#aws-cloudwatch</ExpTag>
        <ExpTag>#aws-route-53</ExpTag>
        <ExpTag>#ssl-tls</ExpTag>
        <ExpTag>#aws-certificate-manager</ExpTag>
        <ExpTag>#aws-vpc</ExpTag>
      </>,
      <>
  ...
  },
  {
    ...
    details: [
      ...
      <>
        ...
        <ExpTag>#aws-ec2</ExpTag>
        <ExpTag>#aws-rds</ExpTag>
        <ExpTag>#aws-load balancer</ExpTag>
        <ExpTag>#aws-dynamo-db</ExpTag>
        <ExpTag>#aws-s3</ExpTag>
        <ExpTag>#aws-cloudwatch</ExpTag>
        <ExpTag>#https</ExpTag>
        <ExpTag>#firewall</ExpTag>
        <ExpTag>#subnetting</ExpTag>
      </>,
      <>
