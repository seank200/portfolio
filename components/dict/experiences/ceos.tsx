...
export const ceosDict = createIntlDict(
  ...
  },
  {
    ...
    DETAILS: [
      ...
      '[부원] 매주 동아리 정규 세션에 참여하여 서비스 기획, 시장 조사, 마케팅 계획 등 서비스 런칭에 필요한 지식을 습득하고, 매주 파트 스터디 세션을 통해 React 개발 실습 과제와 이론 스터디를 진행함. 정규 세션과는 별도로, 동기 부원들과 함께 전 활동기간에 걸쳐 일일 스터디를 함께 진행하여 개발 과제 진행과 이론 공부를 진행하였음.',
    ],
  }
);
