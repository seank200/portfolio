...
export const anlDict = createIntlDict(
  {
    ...
    DETAILS: [
      ...
      <>
        ...
        (U.S., Canada, India, Taiwan, Italy, Greece, etc.). In addition to daily
        lab meetings, participated in after-hours study sessions with fellow
        interns every weekend for studying related theories and research papers.
      </>,
  ...
  },
  {
    ...
    DETAILS: [
      <>
        ...
        성능 테스트를 진행함. 알고리즘 정확도를 약 15% 향상시켰고, 순차(serial)
        처리 대비 병렬 처리 구현을 통해 실행 시간을 최대 40%까지 단축하였음.
        <span className={tagStyle}>#c++</span>
        <span className={tagStyle}>#mpi</span>
      </>,
      <>
        <span className="font-bold">[협업] </span>
        일일 연구실 전체 회의에 참여하여 연구 진행사항 보고 및 알고리즘 최적화
        방안 등에 대해 논의하였음. 회의 시, MATLAB을 사용하여 알고리즘 정확도,
        코어 수 별 실행시간 등을 시각화하여 문제 분석 및 개선 방안 논의가
        용이하도록 하였음. 효율적 MPI 메세징 관리와 Quasi-Newton Method를 사용한
        경사하강법 최적화 등 다양한 코드 효율성 개선 방안에 대한 의견을 공유를
        통해 알고리즘 정확도를 향상시키고 실행시간을 단축하였음.
        <span className={tagStyle}>#matlab</span>
      </>,
      <>
        <span className="font-bold">[소통,노력] </span>
        다양한 국가 출신(미국, 캐나다, 인도, 태국, 이탈리아, 그리스 등)의
        교수진, 연구원, 학생들과 함께 협업하고 긴밀한 관계를 맺음. 일일 연구실
        회의에 더불어 매주 주말 동료 학생 및 인턴들과 함께 근무 외 시간을
